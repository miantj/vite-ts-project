...
watch(
    ...
    (news, old) => {
        if (news) {
            const index = gridData.pace[gridData.user - 1]
            const parentNode = gridData.grids[index - 2].parentNode
            const dom = parentNode.getElementsByClassName('topic')
            console.warn(dom[0], gridData.topics)
    ...
    <div class="main">
        ...
        <div class="grid">
            ...
            <div class="grid-item" style="background: #529b2e">
                <i class="index">8</i>
                <div>
                    <span style="color: red">原地转5圈</span>
                </div>
                <el-icon :size="50">
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48">
            ...
            <div class="grid-item" style="background: #a0cfff">
                <i class="index">14</i>
                <div><span style="color: red">再投一次</span></div>
                <el-icon :size="50">
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48">
                        <path
                            fill="#45413c"
            ...
            <div class="grid-item" style="background: #79bbff">
                <i class="index">18</i>
                <div><span style="color: red">后退2格</span></div>
                <el-icon :size="50">
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48">
