...
const { logout, onPanel, changeTitle, toggleSideBar, pureApp, usename, getDropdownItemStyle } = useNav()
...
<template>
    <div class="navbar">
        ...
        <div v-if="pureApp.layout === 'vertical'" class="vertical-header-right">
            ...
            <el-icon class="el-icon-setting" :title="$t('buttons.hssystemSet')" @click="onPanel">
